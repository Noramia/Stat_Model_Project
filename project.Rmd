...
The aim of this study is to produce the best predictive model for mammogram mass severity. The model must have maximum parsimony whilst having minimun residual error. Predicted probabilities of severity may also be generated from the model. This information may 
